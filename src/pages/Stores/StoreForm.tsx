...
function StoreForm({value, onChange, onSubmit, submitLabel, disabled }: StoreFormProps) {
    ...
    <form onSubmit={async(e) =>{
        ...
        <Label htmlFor="name" className="py-2">店舗名</Label>
        <Input name="name"
        value={value.name}
        onChange={(e) => {
        ...
        <Label htmlFor="postalCode" className="py-2">郵便番号</Label>
        ...
        <Label htmlFor="prefecture" className="py-2">都道府県</Label>
        ...
        <Label htmlFor="city" className="py-2">市町村</Label>
        <Input name="city"
        value={value.city}
        onChange={(e) => {
        ...
        <Label htmlFor="addressLine" className="py-2">番地以降</Label>
        ...
        <div className="flex items-center gap-3">
            ...
            <Label htmlFor="isActive" className="py-2">公開しない</Label>
        </div>
